...
//  №1 Отсортировать строки, состоящие только из латинских строчных букв, в файле
//  по примеру с занятия.

public class Task1 {
    private static int chars = 26;

    public static void main(String[] args) throws FileNotFoundException {
        File file = new File("src\\task1\\in.txt");
    ...
    public static void union() throws FileNotFoundException {
        ...
        for (int i = 0; i < chars; i++) {
            scanners[i] = new Scanner(new File("src\\task1\\letters\\letter" + i + ".txt"));
        }
    ...
    public static void split(int count) throws FileNotFoundException {
        ...
        for (int i = 0; i < chars; i++) {
            printWriters[i] = new PrintWriter("src\\task1\\letters\\letter" + i + ".txt");
        }
